                ...
                @auth 
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            <span class="block px-4 py-2 text-sm leading-5 text-gray-700 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 transition duration-150 ease-in-out">Tu rol es <b>{{ Auth::user()->rol }}</b></span>
                        </x-slot>
                    </x-dropdown>
                @else 
